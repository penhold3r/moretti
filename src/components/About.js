...
const About = () => (
	<section className='about section pt-5' id='nosotros'>
		<Container fluid className='bg-primary p-5 mb-5'>
			<Image src={logoFull} style={{ objectFit: 'contain', height: '150px', width: '100%' }} />
		</Container>
		<Container className='py-5'>
			<Card className={`shadow-sm border-0 p-0 p-md-3 bg-white`}>
				<Card.Body>
					<Row>
						<Col sm={12} md={4} className='d-flex' style={{ height: isMobile ? '175px' : 'auto' }}>
						...
						<Col sm={12} md={8} className='pr-md-5'>
							...
							<p className='lead py-2'>
								...
								seguro, con más de 20 años de experiencia en la materia.
							</p>
