					...
					<Card.Body>
						<Row>
							...
							<Col sm={12} md={8} className="pr-md-5">
								<h2 className="about-title display-4 mt-4 mt-md-0">
									¿Quienes Somos?
								</h2>
								<p className="lead py-2">
									Somos una organización de productores asesores especializados
									en varias ramas del seguro, con más de 20 años de experiencia
									en la materia.
								</p>
								...
								<p className="text-primary-grey">
									Fieles a la palabra "Productor" y amantes de la palabra
									"Asesor".
								</p>
							</Col>
						</Row>
